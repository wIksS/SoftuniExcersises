...
[TestFixture]
public class T014_Computer_GetCpu
{
    // MUST exist within project, otherwise a Compile Time Error will be thrown.
    private static readonly Assembly ProjectAssembly = typeof(StartUp).Assembly;

    [Test]
    public void ReturnCPUByBrandCPUnotFound()
    {
        ...
        var returnedCpu =
            InvokeMethod(computer, "GetCPU", new object[] { "AMD FX-83708" });

        Assert.AreEqual(null, returnedCpu);
    }
