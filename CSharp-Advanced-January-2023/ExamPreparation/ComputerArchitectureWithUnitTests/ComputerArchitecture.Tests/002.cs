...
[TestFixture]
public class T002_CPUProperties
{
    ...
    [Test]
    public void ValidateCPUProperties()
    {
        var type = GetType("CPU");

        var properties = new[]
        {
            new Property(typeof(string), "Brand"),
            new Property(typeof(int), "Cores"),
            new Property(typeof(double), "Frequency")
        };
