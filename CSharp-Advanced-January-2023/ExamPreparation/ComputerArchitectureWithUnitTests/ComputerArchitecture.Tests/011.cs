...
[TestFixture]
public class T011_Computer_MostPowerful
{
    // MUST exist within project, otherwise a Compile Time Error will be thrown.
    private static readonly Assembly ProjectAssembly = typeof(StartUp).Assembly;

    [Test]
    public void MostPowerfulReturnCPU()
    {
        ...
        var returnedCpu =
            InvokeMethod(computer, "MostPowerful", null);
        ...
        Assert.AreEqual(12.7, returnedFrequncy);
        Assert.AreEqual("AMD FX-83703", validateReturnedName);
    }
