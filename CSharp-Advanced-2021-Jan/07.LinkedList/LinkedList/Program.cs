...
namespace CustomDoublyLinkedList
{
    public class StartUp
    {
        static void Main(string[] args)
        {
            ...
            linkedList.AddHead(new Node<int>(5));
            linkedList.AddHead(new Node<int>(4));

            linkedList.ForeachFromHead(n => Console.WriteLine(n.Value));
        ...
        //    SoftuniLinkedList<int> linkedList = new SoftuniLinkedList<int>();
